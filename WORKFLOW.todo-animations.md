...
polling:
  ...
  interval_ms: 300000
workspace:
  root: /tmp/symphony-todo-animations-workspaces
hooks:
  after_create: |
    if [ ! -d .git ]; then
      git clone https://github.com/sboesen/symphony-todo-animations .
...
github:
  webhook:
    ...
    auto_register: true
    provider: ngrok
    repo: sboesen/symphony-todo-animations
linear:
  webhook:
